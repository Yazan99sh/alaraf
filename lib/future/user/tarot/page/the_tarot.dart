...
class TheTarot extends StatefulWidget {
  @override
  _TheTarotState createState() => _TheTarotState();
}

class _TheTarotState extends State<TheTarot> {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: AlarafActivityInfo(
                                      ...
                                      imageUrl: "assets/images/activity/tarot.png",
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              AlarafAcitvityForm(model: model,acitivtyType: 2,translate: translate,),
                              SizedBox(
                                height: 10,
                              ),
                            ],
