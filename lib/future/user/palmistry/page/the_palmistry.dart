...
class ThePalmistry extends StatefulWidget {
  @override
  _ThePalmistryState createState() => _ThePalmistryState();
}

class _ThePalmistryState extends State<ThePalmistry> {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: AlarafActivityInfo(
                                      title:
                                      "${translate[StringKeys.str_palmistry]}",
                                      imageUrl: "assets/images/activity/hand.png",
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              AlarafAcitvityForm(model: model,acitivtyType: 3,translate: translate,),
