...
class TheFace extends StatefulWidget {
  @override
  _TheFaceState createState() => _TheFaceState();
}

class _TheFaceState extends State<TheFace> {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: AlarafActivityInfo(
                                      ...
                                      imageUrl: "assets/images/activity/face.png",
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              AlarafAcitvityForm(model: model,acitivtyType: 4,translate: translate,),
                              SizedBox(
                                height: 10,
                              ),
                            ],
