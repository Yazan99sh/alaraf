...
class TheMySoulRevealed extends StatefulWidget {
  @override
  _TheMySoulRevealedState createState() => _TheMySoulRevealedState();
}

class _TheMySoulRevealedState extends State<TheMySoulRevealed> {
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Center(
                                    child: AlarafActivityInfo(
                                      title:
                                      "${translate[StringKeys.str_spiritual]}",
                                      imageUrl: "assets/images/activity/aura.png",
                                    ),
                                  ),
                                ],
                              ),
                              ...
                              AlarafAcitvityForm(model: model,acitivtyType: 8,translate: translate,),
                              SizedBox(
                                height: 10,
                              ),
                            ],
