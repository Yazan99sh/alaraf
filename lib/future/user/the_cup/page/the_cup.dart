...
class TheCup extends StatefulWidget {
  @override
  _TheCupState createState() => _TheCupState();
}

class _TheCupState extends State<TheCup> {
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              Center(
                                child: AlarafActivityInfo(
                                  ...
                                  imageUrl: "assets/images/activity/cup.png",
                                ),
                              ),
                            ],
                          ),
                          ...
                          AlarafAcitvityForm(model: model,acitivtyType: 1,translate: translate,),
                          SizedBox(
                            height: 10,
                          ),
                        ],
